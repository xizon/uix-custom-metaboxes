...
*
*/
class UixXXXCmbFormType_Color extends Uix_XXX_Custom_Metaboxes {
	...
	?>
		...
		<?php endif; ?>     
				   ...
				   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-xxx-cmb__color-selector" value="<?php echo esc_attr( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
