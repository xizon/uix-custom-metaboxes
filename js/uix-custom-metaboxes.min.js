...
var UixCustomMetaboxes=function(obj){"use strict";var UixCustomMetaboxesConstructor=function(obj){this.init=obj;};UixCustomMetaboxesConstructor.prototype={getInstance:function(){jQuery(document).ready(function(){UixCustomMetaboxesConstructor.prototype.radio.call(this,'.uix-cmb__radio-selector');UixCustomMetaboxesConstructor.prototype.toggle.call(this,'.uix-cmb__toggle-selector');UixCustomMetaboxesConstructor.prototype.color.call(this,'.uix-cmb__color-selector');UixCustomMetaboxesConstructor.prototype.tabs.call(this,'.uix-cmb__tabsgroup-selector');UixCustomMetaboxesConstructor.prototype.date.call(this,'.uix-cmb__date-selector');UixCustomMetaboxesConstructor.prototype.upload.call(this,'.uix-cmb__upload-target');UixCustomMetaboxesConstructor.prototype.customAttrs.call(this,'.uix-cmb__custom-attributes-field',100);UixCustomMetaboxesConstructor.prototype.expandItem.call(this,'.uix-cmb__text--div--toggle__trigger');UixCustomMetaboxesConstructor.prototype.titleChange.call(this,'.uix-cmb__text--div--toggle','.uix-cmb__text--div--toggle__trigger','.uix-cmb__text--div--toggle__title');UixCustomMetaboxesConstructor.prototype.editor.call(this);UixCustomMetaboxesConstructor.prototype.toggleSelect.call(this);});return this;},expandItem:function(selector){jQuery(document).ready(function(){jQuery(document).off('click.UixCmbToggle').on('click.UixCmbToggle',selector,function(){jQuery(this).parent().toggleClass('active');jQuery(this).toggleClass('active');});});return this;},titleChange:function(wrapper,trigger,title){jQuery(document).ready(function(){jQuery(document).off('input.UixCmbTitle change.UixCmbTitle').on('input.UixCmbTitle change.UixCmbTitle',title,function(){jQuery(this).closest(wrapper).find(trigger+'> span').html(jQuery(this).val());});});return this;},radio:function(selector){jQuery(document).ready(function(){jQuery(selector).each(function(){var $this=jQuery(this),tid=$this.data('target-id');$this.find('[data-value]').on('click',function(){var _curValue=jQuery(this).attr('data-value');$this.find('[data-value]').removeClass('active');jQuery('#'+tid).val(_curValue);jQuery(this).addClass('active');});});});return this;},toggle:function(selector){jQuery(document).ready(function(){jQuery(selector).each(function(){var $this=jQuery(this);var tid=$this.attr('data-toggle-id');if($this.hasClass('active')){if(tid!=''||typeof tid!==typeof undefined){$this.closest('[data-target-id]').find('.uix-cmb__toggle-target').hide();jQuery('#'+tid).show();}}
...
jQuery(this).addClass('active');});});});return this;},tabs:function(selector){jQuery(document).ready(function(){jQuery(selector).each(function(){var $this=jQuery(this),tabID=$this.attr('id');$this.find('> ul').find('li').each(function(index){jQuery(' a',this).attr('href','#tab-'+index+tabID);});$this.find('.item').each(function(index){jQuery(this).attr('id','tab-'+index+tabID);});$this.find('> ul').each(function(){var $active,content,links=jQuery(this).find('a');$active=jQuery(links.filter('[href="'+location.hash+'"]')[0]||links[0]);$active.addClass('active');content=jQuery($active[0].hash);$this.find('> ul').find('li a').removeClass('active');links.not($active).each(function(){jQuery(this.hash).hide();});$this.find('> ul').find('li:first a').addClass('active');$this.find('.item:first').show();jQuery(this).find('a').off('click');jQuery(this).on('click','a',function(e){$active.removeClass('active');content.hide();$active=jQuery(this);content=jQuery(this.hash);$active.addClass('active');content.show();e.preventDefault();});});});});return this;},color:function(selector){jQuery(document).ready(function(){if(jQuery.isFunction(jQuery.fn.wpColorPicker)){jQuery(selector).wpColorPicker();}});return this;},date:function(selector){jQuery(document).ready(function(){if(jQuery.isFunction(jQuery.fn.datepicker)){jQuery(selector).each(function(){var $this=jQuery(this),format=$this.data('format');$this.datepicker({dateFormat:format,changeMonth:true,changeYear:true,nextText:'→',prevText:'←'});});}});return this;},editor:function(){jQuery(document).ready(function(){jQuery('.uix-cmb__mce-editor').UixCmbEditorInit();});return this;},toggleSelect:function(){jQuery(document).ready(function(){jQuery('.uix-cmb__text--div--toggle').UixCmbToggleSelectInit();});return this;},upload:function(selector){jQuery(document).ready(function(){jQuery(selector).each(function(){var $this=jQuery(this),pid=$this.data('insert-preview'),rid=$this.data('remove-btn'),tid=$this.data('insert-img'),_closebtn='#'+rid;if(jQuery('#'+tid).val()!=''){jQuery(_closebtn).show();$this.hide();}else{$this.show();}
if(_closebtn){jQuery(_closebtn).off('click');jQuery(document).on('click',_closebtn,function(event){event.preventDefault();jQuery('#'+tid).val('');jQuery('#'+pid).find('img').attr('src','');jQuery('#'+pid).hide();jQuery(this).hide();$this.show();$this.data('click',1);});}});jQuery(selector).off('click').data('click',1);jQuery(document).on('click',selector,function(e){e.preventDefault();var $this=jQuery(this),pid=$this.data('insert-preview'),rid=$this.data('remove-btn'),tid=$this.data('insert-img');var upload_frame,attachment,_closebtn='#'+rid;if($this.data('click')==1){if(upload_frame){upload_frame.open();return;}
upload_frame=wp.media({title:'Select Files',button:{text:'Insert into post',},multiple:false});upload_frame.on('select',function(){attachment=upload_frame.state().get('selection').first().toJSON();jQuery('#'+tid).val(attachment.url);jQuery('#'+pid).find('img').attr('src',attachment.url);jQuery('#'+pid).show();if(_closebtn){jQuery(_closebtn).show();$this.hide();}});upload_frame.open();}
$this.data('click',0);if(_closebtn){jQuery(_closebtn).off('click');jQuery(document).on('click',_closebtn,function(event){event.preventDefault();jQuery('#'+tid).val('');jQuery('#'+pid).find('img').attr('src','');jQuery('#'+pid).hide();jQuery(this).hide();$this.show();$this.data('click',1);});}});});return this;},customAttrs:function(selector,max){jQuery(document).ready(function(){jQuery(selector).each(function(){var $this=jQuery(this),$addButton=$this.find('.uix-cmb__custom-attributes-field__addbtn'),wrapperID='#'+$this.data('append-id'),x=1,maxField=max,fieldHTML=$this.data('tmpl');$addButton.off('click.UixCustomMetaboxes_customAttrs_add').on('click.UixCustomMetaboxes_customAttrs_add',function(e){e.preventDefault();if(x<maxField){x++;var uuid=UixCmbGUID.create();jQuery(wrapperID).append(fieldHTML.replace(/\{id\}/g,uuid));jQuery.when(jQuery(wrapperID).length>0).then(function(){UixCustomMetaboxesInit.toggleSelect();UixCustomMetaboxesInit.editor();});}
